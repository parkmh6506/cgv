...
const movieChartBtn1 = document.querySelector(
  ".btn_wrap > h3:nth-of-type(1) > a"
);
const movieChartBtn2 = document.querySelector(
  ".btn_wrap > h3:nth-of-type(2) > a"
);
...
const clickBtn = document.querySelector(
  ".movieChart1 .movieChart1_contents .movieChart1_btn > a"
);
const btns = document.querySelectorAll(
  ".swiper .swiper-slide > .movieChart2_btn"
);
...
const expectedAge2 = [
  "url('./image/age_15.png')",
  "url('./image/age_All.png')",
  "url('./image/age_15.png')",
  "url('./image/age_12.png')",
  "url('./image/age_15.png')",
  "url('./image/age_12.png')",
  "url('./image/age_All.png')",
  "url('./image/age_15.png')",
...
movieChartBtn1.addEventListener("click", () => {
  viewBtns.forEach((viewBtn) => {
    if (viewBtn.classList.contains("block")) viewBtn.classList.remove("block");
  });
  closeBtns.forEach((closeBtn) => {
